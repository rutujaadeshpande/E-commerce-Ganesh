...
<section class="checkout-orders">
   ...
   <h3>your orders</h3>
      ...
      ?>
         ...
         <div class="grand-total">Total Amount : <span>Rs<?= $grand_total; ?>/-</span></div>
      </div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>pin code :</span>
            <input type="number" min="0" name="pin_code" placeholder="e.g. 123456"  onkeypress="if(this.value.length == 6) return false;" class="box" required>
         </div>
      </div>
