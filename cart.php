...
<head>
   ...
   <style>
        body {
            background-image: url('images/9W4A1116.jpg');
...
<section class="products shopping-cart">
   ...
   <form action="" method="post" class="box">
      ...
      <div class="sub-total"> sub total : <span>Price:<?= $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</span> </div>
   ...
   <div class="cart-total">
      <p>Total Amount : <span>Price:<?= $grand_total; ?>/-</span></p>
